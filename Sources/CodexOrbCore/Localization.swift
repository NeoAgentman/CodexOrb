...
public enum L10n {
    ...
    static let english: [String: String] = [
        ...
        "处理损坏的重置记录": "Handle damaged reset record",
        "处理损坏的重置记录？": "Handle the damaged reset record?",
        "无法安全恢复这条记录。移出后可以继续使用其他重置卡，原文件会保留。仅在确认没有待恢复操作时继续。": "This record cannot be recovered safely. Move it out to use other reset cards. The original file will be kept. Continue only if no operation needs recovery.",
        "移出记录并继续": "Move record and continue",
        "已移出损坏的重置记录。": "The damaged reset record was moved out.",
        "无法处理损坏的重置记录。": "Could not handle the damaged reset record.",
        "长期": "No expiry",
        ...
        "30 天剩余额度": "30-day usage limit",
        "30 天重置剩余时间": "30-day reset countdown",
        ...
        "请先选择一个可用账号。": "Select an available account first.",
        ...
        "将清理该账号的 OAuth 凭据、账号文件和本地重置记录。点击“保存”后完成。": "The account's OAuth credentials, account files, and local reset record will be removed when you click Save.",
        "账号已移除，点击“保存”完成清理。": "Account removed. Click Save to finish cleaning it up.",
        "删除账号失败，请重试。": "Could not delete the account. Please try again.",
        ...
        "只能删除 CodexOrb 管理的账号。": "Only CodexOrb-managed accounts can be deleted.",
